...
public class BluetoothChatService {
    ...
    public synchronized void start() {
        ...
        Log.d("aaaa", ""+ STATE_LISTEN + " "+ mSecureAcceptThread+ " " +mInsecureAcceptThread);
        ...
        public void run() {
            ...
            try {
            	...
            	try {
                    ...
                    Log.d("exxxx","Connected");
                }
            	catch (Exception e2) {
                    Log.e("exxx", e2.getMessage()+ " Couldn't establish Bluetooth connection!");
                 // Close the socket
                    try {
                        mmSocket.close();
